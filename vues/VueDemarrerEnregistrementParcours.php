	...
	<head>
		...
		<script>
			...
			$(document).bind('pageinit', function() {
				...
				$('#caseEnvoyerMel').click( activerBouton );
			...
			<div data-role="content">
				...
				<form action="index.php?action=DemarrerEnregistrementParcours" method="post" data-ajax="false">
					...
					<div data-role="fieldcontain" data-type="horizontal" class="ui-hide-label">
    					<label for="caseEnvoyerMel">Cochez si vous souhaitez envoyer un mail aux utilisateurs autorisés</label>
    					<input type="checkbox" name="caseEnvoyerMel" id="caseEnvoyerMel" data-mini="true" <?php if ($envoyerMel == 'on') echo 'checked'; ?>>
    				</div>	
