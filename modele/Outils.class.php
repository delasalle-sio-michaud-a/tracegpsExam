...
// 	}
	...
	{	// utilisation d'une expression régulière pour vérifier un mot de passe
	    // les seuls caractères autorisés sont les lettres minuscules, les lettres majuscules et les chiffres
	    $EXPRESSION = "^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.{8,})^";
	    // on retourne true si le mot de passe est bon, mais aussi si le mot de passe est vide :
	    if ( !preg_match ( $EXPRESSION , $unMdp) == true || $unMdp == "" ) return false; else return true;
	}
